<?php
  ...
  $address = "139.144.171.74"; //Server IP (If same server use localhost)

  $serverPort = 22; //SSH port (Default 22)
 
  $user = "master_nwffqhkqzr"; //User for the server
 
  $password = "Mrp86YQf"; //Password for the server
  
  $Methods = array("DNS", "STOP"); //Array of methods

  $APIKey = "KissC2"; //Your API Key
